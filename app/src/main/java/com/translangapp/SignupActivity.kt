...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signup = findViewById<com.google.android.material.textfield.TextInputLayout>(R.id.btnSignUp) as Button
        signin = findViewById<TextView>(R.id.txtSignIn) as Button
        DB = DBHelper(this)
